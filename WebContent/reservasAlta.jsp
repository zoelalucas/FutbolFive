...
<div class="card">	
	<center>
	<h5 class="card-title"><u>Buscar/Reservar </u></h5>
  <br>
					<!-- Busca los complejos del Usuario -->
					
						<div class="form-group form-group-lg">
					        <label class="col-sm-8 control-label" for="lg" for="cboCategoriaProducto">Complejo</label>
					        <div class="col-sm-8">   
					            
					        <select class="form-control" id="cboCategoriaProducto" name="Nombre_Comp" value=Nombre_Comp>
					      <%
				ArrayList<reservasMODELO> reservasmodelos1 = (ArrayList<reservasMODELO>)request.getAttribute("reservasmodelos1");
			
				if (reservasmodelos1 != null)
				{%>
					      	<% for (int i=0; i<reservasmodelos1.size(); i++){
					      reservasMODELO reservasmodelo = reservasmodelos1.get(i);
						%>
					        <option value="<%=reservasmodelo.getCorreo_Usu()%>"><%=reservasmodelo.getCorreo_Usu()%></option>
					        <%}} %>
					        </select>
					...
					<!-- finish Busca los complejos del Usuario -->
...
int calificacion = reservasmodelo.getPromedio_Comp();
    ...
    <!-- Button -->
		<div class="wrap-login100-form-btn"> 
			<div class="login100-form-bgbtn" ></div>
			<button class="login100-form-btn" value="createDueño" name="action" type="submit">
				Reservar
			</button>
		</div>
  </div>
