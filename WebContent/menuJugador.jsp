...
<%if (session.getAttribute("Usuario_Usu")== null){ 
	...
	<!-- Si tiene reservas pendientes de calificar entra a este mensaje-->
<%if (session.getAttribute("msg")=="1"){%>
		<script>
		swal({
			  title: "Atencion!",
			  text: "Tenes reservas pendientes de calificar!",
			  type: "info",
			...
			function(){
			  window.location.href = "reservasCONTROLADOR?action=CalificarReservaUsuario";
			});
		</script>
      ...
      <div id="property-carousel" class="owl-carousel owl-theme">
        <div class="carousel-item-b" >
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
        <img src="img/buscarcanchas.jpeg" alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <a class="price-a"  href=reservasJugAlta.jsp>Buscar Canchas</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <img src="img/reservas.jpeg" alt="" class="img-a img-fluid">
            ...
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <a class="price-a" href="reservasCONTROLADOR?action=ListadoReservaUsuario">Mis Reservas</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="carousel-item-b">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
        <img src="img/soporte.jpeg" alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <a class="price-a" href="#contact">Soporte</a>
                  </div>
                </div>
              </div>
            </div>
